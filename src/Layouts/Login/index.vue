        ...
        <div class="lowin-box-inner">
          <a-form ref="loginForm" :model="loginForm" :rules="loginRules">
            ...
            <div class="lowin-group">
              <label>用户名 </label>
              <a-input ref="account" v-model:value="loginForm.account" class="lowin-input" placeholder="用户名" name="account" type="text" tabindex="1"/>
            </div>
            <div class="lowin-group password-group">
              <label>密码</label>
              <a-input  class="lowin-input" :key="passwordType" ref="password" v-model:value="loginForm.password" :type="passwordType"
                placeholder="密码" name="password" tabindex="2"/>
            </div>
            <a-button :loading="loading" type="text" class="lowin-btn login-btn"  @click="handleLogin">登录</a-button>
          </a-form>
        </div>
      </div>
    </div>
